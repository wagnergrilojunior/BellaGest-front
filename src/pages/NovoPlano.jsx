...
export default function NovoPlano() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await Plano.create(dadosParaEnviar);
      navigate(createPageUrl("Planos"));
    } catch (error) {
      console.error('Erro ao criar plano:', error);
      setErrors(prev => ({ ...prev, geral: "Ocorreu um erro ao criar o plano."}));
    }
    setLoading(false);
  };
          ...
          <CardContent className="p-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea id="descricao" value={dados.descricao} onChange={handleChange} rows={3} placeholder="Descreva os detalhes do plano"/>
              </div>
              <div className="space-y-2">
                <Label htmlFor="recursos">Recursos (um por linha)</Label>
                <Textarea id="recursos" value={dados.recursos} onChange={handleChange} rows={5} placeholder="Recurso 1&#10;Recurso 2&#10;Recurso 3"/>
              </div>
